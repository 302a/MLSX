...
Page({
  ...
  data: {
    ...
    list2: [
      {
        type: '美林门店',
        img: 'http://59.110.218.60/user_page/15.png',
        path: '/pages/store/store',
      },
      {
        type: '美林会员',
        img: 'http://59.110.218.60/user_page/16.png',
        path: '/pages/member/member',
      },
      {
        type: '兑换优惠券',
        img: 'http://59.110.218.60/user_page/17.png',
        path: '/pages/coupon/coupon',
      },
      {
        type: '地址',
        img: 'http://59.110.218.60/user_page/20.png',
    ...
    list3: [
      {
        type: '我的评价',
        img: 'http://59.110.218.60/user_page/19.png',
        path: '/pages/evaluate/evaluate'
      },
      {
        type: '邀请好友',
        img: 'http://59.110.218.60/user_page/18.png',
        path: '/pages/invite/invite'
      },
      {
        type: '预约',
        img: 'http://59.110.218.60/user_page/21.png',
        path: '/pages/subscribe/subscribe'
      },
      {
        type: '分销中心',
        img: 'http://59.110.218.60/user_page/22.png',
